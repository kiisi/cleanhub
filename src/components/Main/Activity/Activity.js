    ...
    <div className="activity">
      <div className="activity_content_wrapper">
        <div className="activity_content">
          ...
          <p>Kartlog helps fashion customers prioritizing consistency and efficiency over individuality, providing ease and comfort in the purchase of custom-made wears.</p>
        </div>
      </div>
